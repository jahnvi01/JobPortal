...
class Home extends Component {
  ...
  render() {
    ...
    <Link to=''><button type="button" className="btn btn-light home-btn">Company</button></Link>

    <Link to=''> <button type="button" className="btn btn-light home-btn">Interviewer</button></Link>
    </div>
    <div className="col-md-3"></div>
    </div>
